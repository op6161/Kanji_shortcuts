# Kanji_shortcuts 일본어 한자 검색 IOS단축어
...
---
한자 텍스트를 단축어에 공유 시, namu.wiki에 기재되어 있는 한자에 대한 정보(음, 훈, 대상한자의 구성한자) 를 출력합니다.
...
<details>
  ...
  探す漢字をショートカットに共有すると、namu.wikiに記載されている漢字の情報(音・訓・漢字を構成する漢字・など)をポップアップで見せる。（※韓国語で）
  
  <a href="#ex">「水族館」を検索時、「館」についての結果
  </a>
